...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6" style="position: relative;">
            <canvas id="pieChart" style="position: absolute; top: 0; left: -50%;" width="400" height="400"></canvas>
            ...
            <div id="legend" class="top" style="position: absolute; top: 40px; left: 50%; transform: translateX(-50%); display: flex; flex-direction: column;">
                <?php
