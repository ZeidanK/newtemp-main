     ...
     <div class="u-layout-col">
                  <div class="u-container-style u-layout-cell u-size-60 u-layout-cell-3">
                    <div class="u-container-layout u-valign-top u-container-layout-3">
                      <h2 class="u-align-right u-text u-text-grey-70 u-text-5">اضافة رسالة </h2>
                      <div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                        <form action="php/guestmsg.php?guest=<?php echo "$GuestSlug" ?>&client=<?php echo "$ClientSlug" ?>" method="post" >
        

                          <label for="message">Message:</label>
                          <textarea placeholder="اكتب هنا" id="message" name="message" rows="5" cols="30" required></textarea><br><br>
